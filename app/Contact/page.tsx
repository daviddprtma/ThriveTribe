        ...
        <div className="flex flex-col gap-5">
          <span className="flex gap-5 align-center">
            <Image
              ...
              height={25}
            />
            <p>davidchristianpratama@gmail.com</p>
          </span>
          <span className="flex gap-5 align-center">
            <Image
              src="/instagram.png"
              ...
              height={25}
            />
            <Link href="https://www.instagram.com/daviddprtma/">
              <p>daviddprtma</p>
            </Link>
          </span>
        </div>
        <div className="flex gap-10">
          <Link href="https://www.linkedin.com/in/david-pratama-8a8aa8284/">
            <Image
          ...
          <Link href="https://x.com/daviddprtma2812">
            <Image
              src="/twitter.png"
              className="hover:scale-110 transition ease-in-out"
              alt="X"
          ...
          <Link href="https://github.com/daviddprtma">
            <Image
